...
exports.UsersModule = UsersModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forFeature([{ name: company_schema_1.Companies.name, schema: company_schema_1.CompaniesSchema }]),
        ],
        controllers: [users_controller_1.UsersController],
        providers: [users_service_1.UsersService, company_service_1.CompanyService]
    })
], UsersModule);
