...
export class EmailsService {
    ...
    constructor(
        @InjectModel(Emails.name) private emailesModel: Model<EmailDocument>,
    ...
    async sendEmailWithOTP(subject: string, template: string, context: any, body: any, request: any) {
